						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<!--begin::Page Title-->
									<h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Wheels G.1 Settings</h2>
									<!--end::Page Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
										...
										<li class="breadcrumb-item">
											<a href="" class="text-muted">Wheels G.1 Settings</a>
										</li>
									</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div class="card card-custom">
								<div class="card-header flex-wrap border-0 pt-6 pb-0">
									<div class="card-title">
										<h3 class="card-label">Wheels G.1 Settings
											<span class="d-block text-muted pt-2 font-size-sm">Setting up your wheels G.1 now</span></h3>
									</div>
								</div>
													...
													<div class="col-xl-12 col-xxl-7">
														...
														<form class="form mt-0 mt-lg-10" id="kt_form">
															...
															<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
																<h2 class="mb-10 font-weight-bold text-dark text-center">Choose your wheel</h2>

																<!-- include type 01 -->
																<?php include "includes/type01.php"; ?>
															...
															<div class="pb-5" data-wizard-type="step-content">
																...
																<!-- include type 02 -->
																<?php include "includes/type02.php"; ?>
															...
															<div class="pb-5" data-wizard-type="step-content">
																...
																<!-- include type 03 -->
																<?php include "includes/type03.php"; ?>
