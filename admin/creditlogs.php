...
<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-static page-loading">
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    <!--begin::Page Title-->
                                    <h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Credit Logs</h2>
                                    <!--end::Page Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="" class="text-muted">Credit Logs</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Credit Logs
                                            <span class="d-block text-muted pt-2 font-size-sm">Credits given by admin & agents</span></h3>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <!--begin: Search Form-->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-xl-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 mt-5 mt-lg-0 d-flex">
                                                        <a href="#" class="btn btn-light-primary px-6 font-weight-bold mr-3">Search</a>
                                                        <a href="?export_creditlogs" class="btn btn-info px-6 font-weight-bold">Export</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="dist/js/creditlogs.js"></script>
