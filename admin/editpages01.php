                     ...
                     <div class="d-flex align-items-center flex-wrap mr-1">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                           ...
                           <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                              ...
                              <li class="breadcrumb-item">
                                 <a href="" class="text-muted">Edit Draws G.1</a>
                              </li>
                           </ul>
                           <!--end::Breadcrumb-->
                        </div>
                     ...
                     <div class="card card-custom">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                           <div class="card-title">
                              <h3 class="card-label">Edit Draws G.1
                                 <span class="d-block text-muted pt-2 font-size-sm">Setting up your Draws G.1 now</span>
                              </h3>
                           </div>
                        </div>
                        <div class="card-body">
                                 ...
                                 <div class="wizard-steps">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                       <div class="wizard-wrapper">
                                          ...
                                          <div class="wizard-label">
                                             <div class="wizard-title">Draw 1</div>
                                    ...
                                    <div class="wizard-step" data-wizard-type="step">
                                       <div class="wizard-wrapper">
                                          ...
                                          <div class="wizard-label">
                                             <div class="wizard-title">Draw 2</div>
                                    ...
                                    <div class="wizard-step" data-wizard-type="step">
                                       <div class="wizard-wrapper">
                                          ...
                                          <div class="wizard-label">
                                             <div class="wizard-title">Draw 3</div>
                                 ...
                                 <div class="card-body p-0">
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                       <div class="col-xl-12 col-xxl-7" id="kt_form">
                                          <!--begin: Wizard Form-->
                                          <!--begin: Wizard Step 1-->
                                          <div id="page01" class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                             <div class="row justify-content-center">
                                                <div class="col-lg-6">
                                                   ...
                                                   <button onclick="javascript:editPageOne();" class="btn btn-primary font-weight-bolder float-right">Save changes</button>
                                                </div>
                                             </div>
                                          </div>
                                          <!--end: Wizard Step 1-->
                                          <!--begin: Wizard Step 2-->
                                          <div id="page02" class="pb-5" data-wizard-type="step-content">
                                             <div class="row justify-content-center">
                                                <div class="col-lg-6">
                                                   <div class="form-group">
                                                      <label>Name :</label>
                                                   ...
                                                   <button onclick="javascript:editPageTwo();" class="btn btn-primary font-weight-bolder float-right">Save changes</button>
                                                </div>
                                             </div>
                                          </div>
                                          <!--end: Wizard Step 2-->
                                          <!--begin: Wizard Step 3-->
                                          <div id="page03" class="pb-5" data-wizard-type="step-content">
                                             <div class="row justify-content-center">
                                                <div class="col-lg-6">
                                                   <div class="form-group">
                                                      <label>Name :</label>
                                                   ...
                                                   <button onclick="javascript:editPageThree();" class="btn btn-primary font-weight-bolder float-right">Save changes</button>
                                                </div>
                                             </div>
                                          </div>
                                          <!--end: Wizard Step 3-->
