                     ...
                     <div class="card card-custom">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                           <div class="card-title">
                              <h3 class="card-label">Profile Settings
                                 <span class="d-block text-muted pt-2 font-size-sm">Update your profile infos</span>
                              </h3>
                           </div>
                        </div>
                        <div class="card-body">
                           ...
                           <div class="row justify-content-center">
                              <div class="col-lg-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="site_name" class="form-control" autocomplete="off">
                                 </div>
                                 <button onclick="javascript:updateClick();" class="btn btn-primary font-weight-bolder float-right" type="submit">Save changes</button>
                              </div>
                           </div>
                           <!--end: Inputs-->
                        </div>
