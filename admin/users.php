						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<!--begin::Page Title-->
									<h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Users List</h2>
									<!--end::Page Title-->
									<!--begin::Breadcrumb-->
								...
								<div class="card-header flex-wrap border-0 pt-6 pb-0">
									<div class="card-title">
										<h3 class="card-label">Users List
											<span class="d-block text-muted pt-2 font-size-sm">List of MTL Wheels Users</span></h3>
									</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button id="save" class="btn btn-primary pull-right" onclick="javascript:addUserClick();">Add User</button>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="form-group">
									<label>Username :</label>
									<input type="text" id="new_username" class="form-control" autocomplete="off" disabled>
								</div>
								<div class="form-group">
									<label>Email : </label>
								...
								<div class="form-group">
									<label for="exampleSelect1">Group :</label>
									<select class="form-control" id="new_group">
							...
							<div class="modal-footer">
								<button id="save" class="btn btn-primary pull-right" onclick="javascript:updateUserClick();">Update</button>
								<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
							</div>
						</div>
					</div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<p>deleting a user will result in the following:
									<ul>
										<li>Will be released from groups</li>
										<li>All their records will be erased.</li>
									</ul>
								</p>
							</div>
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-primary" onclick="javascript:deleteUserClick();">Confirm</button>
							</div>
						</div>
					</div>
				</div>
