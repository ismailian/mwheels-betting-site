						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<!--begin::Page Title-->
									<h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Wheels G.2 Settings</h2>
									<!--end::Page Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
										...
										<li class="breadcrumb-item">
											<a href="" class="text-muted">Wheels G.2 Settings</a>
										</li>
									</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div class="card card-custom">
								<div class="card-header flex-wrap border-0 pt-6 pb-0">
									<div class="card-title">
										<h3 class="card-label">Wheels G.2 Settings
											<span class="d-block text-muted pt-2 font-size-sm">Setting up your wheels G.2 now</span></h3>
									</div>
								</div>
									...
									<div class="wizard wizard-4" id="kt_wizard_v4" data-wizard-state="step-first" data-wizard-clickable="true">
										...
										<div class="wizard-nav">
											<div class="wizard-steps">
												...
												<div class="wizard-step mt-5" data-wizard-type="step">
													...
													<div class="col-xl-12 col-xxl-7">
														...
														<form class="form mt-0 mt-lg-10" id="kt_form">
															...
															<div class="pb-5" data-wizard-type="step-content">
																...
																<!-- include type 03 -->
																<?php include "includes/type04.php"; ?>
															...
															<div class="pb-5" data-wizard-type="step-content">
																...
																<!-- include type 03 -->
																<?php include "includes/type05.php"; ?>
															...
															<div class="pb-5" data-wizard-type="step-content">
																...
																<!-- include type 03 -->
																<?php include "includes/type06.php"; ?>
