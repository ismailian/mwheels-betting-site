...
<head>
	...
	<title><?= (Type::info(3, ['name'])->name) ?> - MTL Wheels</title>
	<!-- favicon -->
...
<body class="index2">
					...
					<div class="section-heading">
						...
						<h5 class="subtitle">
							Prize<span style="-webkit-text-fill-color: #fff;">
								<?php echo (Type::info(3)->prize) ?>
							</span> each wheel
						</h5>
						<h5 class="subtitle">
							Cost<span style="-webkit-text-fill-color: #fff;">
								<?php echo (Type::info(3)->amount) ?>
							</span> each number
						</h5>
						<h5 class="subtitle">
	...
	<script src="assets/js/micro_draws.js"></script>
